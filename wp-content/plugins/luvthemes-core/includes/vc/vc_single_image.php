...
switch ( $source ) {
	...
	case 'external_link':
		...
		$img = array(
			'thumbnail' => '<img class="vc_single_image-img" ' . $hwstring . ' src="' . esc_attr($custom_src) . '" />',
		);
		break;
...
if ( ! $img ) {
	$img['thumbnail'] = '<img class="vc_img-placeholder vc_single_image-img" src="' . esc_attr($default_src) . '" />';
}
