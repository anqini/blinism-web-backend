    ...
    class ReduxFramework_select {
        ...
        public function render() {
            ...
            if ( ! empty( $this->field['options'] ) ) {
                ...
                $placeholder = ( isset( $this->field['placeholder'] ) ) ? esc_attr( $this->field['placeholder'] ) :esc_attr__( 'Select an item', 'fevr' );
                ...
                echo '<strong>' .esc_attr__( 'No items of this type were found.', 'fevr' ) . '</strong>';
            }
        } //function
