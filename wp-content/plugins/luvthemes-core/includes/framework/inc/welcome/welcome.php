<?php
    ...
    class Redux_Welcome {
        ...
        public function change_wp_footer() {
            echo _luv_kses(__( 'If you like <strong>Redux</strong> please leave us a <a href="https://wordpress.org/support/view/plugin-reviews/redux-framework?filter=5#postform" target="_blank" class="redux-rating-link" data-rated="Thanks :)">&#9733;&#9733;&#9733;&#9733;&#9733;</a> rating. A huge thank you from Redux in advance!', 'fevr' ));
        }
        ...
        public function support_hash() {
            ...
            if ( ! empty( $data['identifier'] ) ) {
                ...
                $return['status']  = "error";
                $return['message'] = esc_html__( "Support hash could not be generated. Please try again later.", 'fevr' );
            }
        ...
        public function admin_menus() {
            ...
            // About Page
            $page(
                esc_html__( 'Welcome to Redux Framework', 'fevr' ), esc_html__( 'Redux Framework', 'fevr' ), $this->minimum_capability, 'redux-about', array(
                    $this,
                    'about_screen'
                )
            );
            ...
            // Changelog Page
            $page(
                esc_html__( 'Redux Framework Changelog', 'fevr' ), esc_html__( 'Redux Framework Changelog', 'fevr' ), $this->minimum_capability, 'redux-changelog', array(
                    $this,
                    'changelog_screen'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Get Support', 'fevr' ), esc_html__( 'Get Support', 'fevr' ), $this->minimum_capability, 'redux-support', array(
                    $this,
                    'get_support'
                )
            );
            ...
            // Support Page
            $page(
                esc_html__( 'Redux Extensions', 'fevr' ), esc_html__( 'Redux Extensions', 'fevr' ), $this->minimum_capability, 'redux-extensions', array(
                    $this,
                    'redux_extensions'
                )
            );
            ...
            // Credits Page
            $page(
                esc_html__( 'The people that develop Redux Framework', 'fevr' ), esc_html__( 'The people that develop Redux Framework', 'fevr' ), $this->minimum_capability, 'redux-credits', array(
                    $this,
                    'credits_screen'
                )
            );
            ...
            // Status Page
            $page(
                esc_html__( 'Redux Framework Status', 'fevr' ), esc_html__( 'Redux Framework Status', 'fevr' ), $this->minimum_capability, 'redux-status', array(
                    $this,
                    'status_screen'
                )
            );
        ...
        public function tabs() {
            ...
            <h2 class="nav-tab-wrapper">
                <a class="nav-tab <?php echo $selected == 'redux-about' ? 'nav-tab-active' : ''; ?>"
                    ...
                    <?php esc_attr_e( "What's New", 'fevr' ); ?>
                    ...
                    <?php esc_attr_e( 'Extensions', 'fevr' ); ?>
        ...
        public function about_screen() {
            ...
            require_once LUVTHEMES_CORE_PATH . '/includes/framework/inc/welcome/views/about.php';
        ...
        public function changelog_screen() {
            ...
            require_once LUVTHEMES_CORE_PATH . '/includes/framework/inc/welcome/views/changelog.php';
        ...
        public function redux_extensions() {
            ...
            require_once LUVTHEMES_CORE_PATH . '/includes/framework/inc/welcome/views/extensions.php';
        ...
        public function get_support() {
            ...
            require_once LUVTHEMES_CORE_PATH . '/includes/framework/inc/welcome/views/support.php';
        ...
        public function credits_screen() {
            ...
            require_once LUVTHEMES_CORE_PATH . '/includes/framework/inc/welcome/views/credits.php';
        ...
        public function status_screen() {
            ...
            require_once LUVTHEMES_CORE_PATH . '/includes/framework/inc/welcome/views/status_report.php';
        ...
        public function contributors() {
            ...
            foreach ( $contributors as $contributor ) {
                ...
                $contributor_list .= sprintf( '<a href="%s" title="%s" target="_blank">', esc_url( 'https://github.com/' . $contributor->login ), esc_html( sprintf( __( 'View %s', 'fevr' ), esc_html( $contributor->login ) ) )
                );
