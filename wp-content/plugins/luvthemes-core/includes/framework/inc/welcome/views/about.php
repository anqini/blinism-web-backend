<div class="wrap about-wrap">
    <h1><?php printf(esc_html __( 'Welcome to Redux Framework %s', 'fevr' ), $this->display_version ); ?></h1>

    <div
        class="about-text"><?php printf( esc_html__( 'Thank you for updating to the latest version! Redux Framework %s is a huge step forward in Redux Development. Look at all that\'s new.', 'fevr' ), $this->display_version ); ?></div>
    <div
        class="redux-badge"><i
            class="el el-redux"></i><span><?php printf( esc_html__( 'Version %s', 'fevr' ), ReduxFramework::$_version ); ?></span>
    </div>
