        ...
        class reduxCoreEnqueue {
            ...
            private function register_scripts() {
                ...
                if (  wp_script_is ( 'jquerySelect2' )) {
                    call_user_function('wp_'.'deregister_script', 'jquerySelect2' );
                ...
                Redux_CDN::register_script(
                    'select2-js',
                    ReduxFramework::$_url . 'assets/js/select2' . $this->min . '.js',
            ...
            private function set_localized_data() {
                 ...
                 */
                $save_pending = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/save_pending", esc_html__('You have changes that are not saved. Would you like to save them now?', 'fevr' ) );
                 ...
                 */
                $reset_all = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset", esc_html__('Are you sure? Resetting will lose all custom values.', 'fevr' ) );
                 ...
                 */
                $reset_section = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset_section", esc_html__('Are you sure? Resetting will lose all custom values in this section.', 'fevr' ) );
                 ...
                 */
                $preset_confirm = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/preset", esc_html__('Your current options will be replaced with the values of this preset. Would you like to proceed?', 'fevr' ) );
                global $pagenow;
                $this->parent->localize_data['args'] = array(
                    ...
                    'please_wait'           => esc_html__('Please Wait', 'fevr' ),
                ...
                $this->parent->localize_data['ajax'] = array(
                    'console' => esc_html__('There was an error saving. Here is the result of your action:', 'fevr' ),
                    'alert'   => esc_html__('There was a problem with your action. Please try again or reload the page.', 'fevr' ),
                );
