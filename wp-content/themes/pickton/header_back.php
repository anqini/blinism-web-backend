            	...
            	<div class="inner-container clearfix">
                	...
                	<div class="pull-left logo-outer">
                    	<?php if(pickton_set($options, 'logo_image')):?>
                            <div class="logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url(pickton_set($options, 'logo_image'));?>" alt="<?php esc_attr_e('Pickton', 'pickton');?>" title="<?php esc_attr_e('Pickton', 'pickton');?>"></a></div>
                        <?php else:?>
        	...
        	<div class="auto-container">
            	<div class="nav-outer clearfix">
                    ...
                    <div class="outer-box">
                        ...
                        <a onclick="window.open('https://www16.53kf.com/webCompany.php?kf_sign=zg2MDMTU2ME5NDEwNTk4MDAxODU4MDE1NzIyMDg1MjQ=&arg=10208524&style=1&language=zh-cn&charset=GBK&referer=http%3A%2F%2Fwww.blinism.com%2F&keyword=&tpl=crystal_blue&uid=7c4510f30d18633fc24acb5d5a7950e3&is_group=&tfrom=1', '_blank', 'height=600,width=800,top=50,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no')" class="consult-btn theme-btn"><?php echo wp_kses_post(pickton_set($options, 'btn_title')); ?></a>
                        <?php endif;?>
                    </div>
                    <?php endif;?>
                </div>
