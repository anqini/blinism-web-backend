<?php pickton_bunch_global_variable();
	...
	$layout = pickton_set( $settings, 'search_page_layout', 'right' );
	$sidebar = pickton_set( $settings, 'search_page_sidebar', 'default-sidebar' );
	...
	$bg = pickton_set($settings, 'search_page_header_img');
	$title = pickton_set($settings, 'search_page_header_title');
?>
        ...
        <div class="row clearfix">
			...
			<?php else : ?>
                <div class="<?php echo esc_attr($classes);?>">
                    <p><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'pickton' ); ?></p>
                    <aside class="sidebar">
                    <?php get_search_form(); ?>
                    </aside>
                </div>
